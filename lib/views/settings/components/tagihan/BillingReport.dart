  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ChangeNotifierProvider(
        ...
        child: Consumer<ProviderReportBilling>(
          builder: (context,p,w) {
              ...
              PaymentData(DateTime(2024, 12, 1), 1200000),
               ...
               color: Color.fromARGB(255, 89, 148, 250),
                      ...
                      decoration:  InputDecoration(
                        label: Icon(ft.LineIcons.calendarWithDayFocus,size: 30,),
     ...
     GestureDetector(
      ...
      body: ft.Builder(
                ...
                child: ft.Column(
                  ...
                  children: [
                      ...
                      builder: (context, provider, state) {
                             return Container(
                                      ...
                                      child: ft.AutoSuggestBox<ModelPasien>(
                                        ...
                                        placeholder: selectedname == ''? "Cari Nama Pasien" : selectedname,
                    ...
                    onChanged: (z){
                        setState(() {
                          selectedType = z!;
                          print(types[selectedType].toString());
                          p.setype(types[selectedType].toString());
                        });
                    }),
                        SizedBox(height: 8),
       ...
       child: Container(
        ...
        child: Icon(ft.LineIcons.search,size: 21,)),
     ),
Gap(8),
     GestureDetector(
      onTap: (){
      ...
      child:  Container(
        ...
        child: Icon(ft.LineIcons.eraser,size: 21,)),
     ),
                          Gap(8)
                        ],
                      ),
    ...
    return DataRow(
      color: MaterialStateProperty.resolveWith<Color>(
        (Set<MaterialState> states) {
          if (isEvenRow) return Colors.blue.withOpacity(0.1); // Warna biru muda untuk baris genap
          return Colors.white; // Warna putih untuk baris ganjil
        },
      ),
      cells: [
        DataCell(Padding(padding: EdgeInsets.all(4), child: Text(invoice.createdAt.toString().substring(0,10)))),
        DataCell(Padding(padding: EdgeInsets.all(4), child: Row(
          children: [
            SizedBox(
              width: 70,
              child: Text(invoice.idTagihan!,maxLines: 1,)),
            Icon(Icons.copy)
          ],
        ))),
        DataCell(Padding(padding: EdgeInsets.all(4), child: Text(invoice.namaPasien!))),
        ...
        DataCell(Padding(padding: EdgeInsets.all(4), child: Text(invoice.tanggalTerakhirPayment!))),
        DataCell(Text(invoice.statusPaid == "0"? "BELUM LUNAS" : "LUNAS", style: TextStyle(color: invoice.statusPaid == '0' ? Colors.red : Color.fromARGB(255, 32, 153, 64)))),
            ...
            children: [
              GestureDetector(
                ...
                child: Container(
                  padding: EdgeInsets.all(4),
                  decoration: BoxDecoration(
                    color: Color.fromARGB(255, 60, 177, 58)
                  ),
                  child: Text("CETAK BILLING",style: TextStyle(
                    color: Colors.white,
                    fontWeight: FontWeight.bold
                  ),)),
              ),
               ...
               ft.Padding(
                 ...
                 child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text("LIHAT BILLING",style: TextStyle(
                      color: Colors.white,
                      fontWeight: FontWeight.bold
                    ),)),
                               ),
