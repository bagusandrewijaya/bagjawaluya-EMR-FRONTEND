                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text("Selamat Datang, ${p.name}",style: TextStyle(
                            fontSize: 32,
          ...
          ft.FlyoutTarget(
              ...
              child:GestureDetector(
                child:  Container(
                                        ...
                                        child: Center(
                                          child: Text("${p.name[0]}",style: TextStyle(
                ...
                onTap: () {
                  menuController.showFlyout(
                    autoModeConfiguration: ft.FlyoutAutoConfiguration(
                      preferredMode: ft.FlyoutPlacementMode.topCenter,
                    ),
                    ...
                    builder: (context) {
                      return ft.MenuFlyout(items: [
                       ft. MenuFlyoutItem(
                          leading: const Icon(ft.FluentIcons.user_sync),
                          text: const Text('Details'),
                          onPressed: ft.Flyout.of(context).close,
                        ),
                        ft.MenuFlyoutItem(
                          leading: const Icon(ft.FluentIcons.sign_out),
