                ...
                Expanded(
                  ...
                  child: Row(
                    children: [
                      ...
                      //             ChartData(
                      //                 'Laki-Laki',
                      //                 double.parse(provider.data.isNotEmpty
                      //                     ? provider.data[0].jumlahLakiLaki
                      //                         .toString()
                      //                     : '0'),
                      ...
                      //                 'Perempuan',
                      //                 double.parse(provider.data.isNotEmpty
                      //                     ? provider.data[0].jumlahPerempuan
                      //                         .toString()
                      //                     : '0'),
                      ...
                      //           itemCount:
                      //               1, // Ganti dengan jumlah item yang Anda inginkan
                      //           itemBuilder: (context, index) {
                      //             return ListTile(
                      //               title: Text(
                      //                   'Annisa Sabhila'), // Menampilkan nomor item
                      //               subtitle: Text(
                      //                   'Masuk Pada Tanggal 2024/06/12  '), // Contoh teks tambahan
                      //               leading: CircleAvatar(
                      //                 child: Text((index + 1)
                      //                     .toString()), // Menampilkan nomor item dalam avatar lingkaran
                      //               ),
                      //               onTap: () {
